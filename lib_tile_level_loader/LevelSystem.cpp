...
size_t LevelSystem::getWidth() const {
    return _width; // Return the width of the level
}

size_t LevelSystem::getHeight() const {
    return _height; // Return the height of the level
}
